...
function validateTemplate(template: unknown, index: number): ValidationError[] {
  ...
  if (typeof template.trigger !== 'string' || template.trigger.trim() === '') {
    errors.push({
      ...
      message: 'Template trigger must be a non-empty string',
    });
  }
  ...
  if (typeof template.content !== 'string') {
    errors.push({
      ...
      message: 'Template content must be a string',
    });
  }
  ...
  if (template.groupId !== undefined && typeof template.groupId !== 'string') {
    errors.push({
      ...
      message: 'Template groupId must be a string if provided',
    });
  }
  ...
  if (!Array.isArray(template.tags)) {
    ...
    errors.push({
      field: `${prefix}.tags`,
      message: 'Template tags must all be strings',
    });
  }
  ...
  if (typeof template.createdAt !== 'number') {
    errors.push({
      ...
      message: 'Template createdAt must be a number',
    });
  }
  ...
  if (typeof template.updatedAt !== 'number') {
    errors.push({
      ...
      message: 'Template updatedAt must be a number',
    });
  }
  ...
  if (typeof template.usageCount !== 'number') {
    errors.push({
      ...
      message: 'Template usageCount must be a number',
    });
  }
...
function validateGroup(group: unknown, index: number): ValidationError[] {
  ...
  if (typeof group.order !== 'number') {
    errors.push({
      field: `${prefix}.order`,
      message: 'Group order must be a number',
    });
  }
...
export function validateBackup(data: unknown): ValidationResult {
  ...
  if (typeof data.exportedAt !== 'string') {
    errors.push({
      field: 'exportedAt',
      message: 'exportedAt field must be a string',
    });
  }
