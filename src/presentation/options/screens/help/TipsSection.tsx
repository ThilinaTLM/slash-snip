            ...
            <div className="help-tips-grid">
              <div className="help-tip-card">
                ...
                <p className="help-tip-text">
                  Create groups to organize related templates. Use groups for
                  different projects, clients, or template types (emails, code,
                  etc.).
                </p>
              </div>
              ...
              <div className="help-tip-card">
                ...
                <p className="help-tip-text">
                  For templates with multiple fields, use{' '}
                  <code>{'<tab:1>'}</code>, <code>{'<tab:2>'}</code>, etc. Press
                  Tab to jump between fields after expansion.
                </p>
              </div>
              ...
              <div className="help-tip-card">
                ...
                <p className="help-tip-text">
                  Combine clipboard with transforms for powerful workflows. Copy
                  text, then use <code>{'<clipboard:upper>'}</code> or{' '}
                  <code>{'<clipboard:title>'}</code>.
                </p>
              </div>
              ...
              <div className="help-tip-card">
                ...
                <p className="help-tip-text">
                  ...
                  <code>{'<input:Priority:Medium>'}</code> or{' '}
                  <code>{'<tab:1:TODO>'}</code>.
                </p>
              </div>
              ...
              <div className="help-tip-card">
                ...
                <p className="help-tip-text">
                  Export your templates regularly from the Settings page. This
                  creates a JSON backup you can import later or share with
                  teammates.
                </p>
              </div>
            </div>
